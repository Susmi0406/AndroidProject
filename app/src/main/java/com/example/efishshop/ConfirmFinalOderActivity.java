...
public class ConfirmFinalOderActivity extends AppCompatActivity {
    ...
    private void Check() {
        if (TextUtils.isEmpty(nameEditText.getText().toString())){
            ...
            Toast.makeText(this, "Please provide your Shipment Address ..", Toast.LENGTH_SHORT).show();
        }
                    ...
                    FirebaseDatabase.getInstance().getReference().child("Cart List")
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful())
                                    {
                                        Toast.makeText(ConfirmFinalOderActivity.this,"Your final order has been placed successfully...", Toast.LENGTH_SHORT).show();
