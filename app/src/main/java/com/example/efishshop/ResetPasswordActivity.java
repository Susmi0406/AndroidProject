...
public class ResetPasswordActivity extends AppCompatActivity {
    ...
    private TextView resetPass, titleQuestions;
    ...
    protected void onStart() {
        ...
        {
            resetPass.setText("Set Questions");
            titleQuestions.setText("Please write answers for the following security questions.");
