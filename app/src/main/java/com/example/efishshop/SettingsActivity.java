...
public class SettingsActivity extends AppCompatActivity {
    ...
    private EditText fullNameEditText, userPhoneEditText, addressEditText, emailEditText, passwordEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userInfoDisplay(profileImageView, fullNameEditText, userPhoneEditText, addressEditText, emailEditText, passwordEditText);
    ...
    private void userInfoDisplay(final CircleImageView profileImageView, final EditText fullNameEditText, final EditText userPhoneEditText, final EditText addressEditText, final EditText emailEditText, final EditText passwordEditText) {
